...
raw-texture四角形で320×240へ拡大します。PCSX-ReARMedでは15コード/秒で、起動を
含む録画開始から約1分52秒で512 KiB全体を表示します。30fps・960×720・H.264録画から
1,649チャンクを復元し、全体CRC32と元BIOSのバイト列が一致することを確認済みです。
